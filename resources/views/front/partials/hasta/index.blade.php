...
@section('content')
    <div class="row">
        ...
        <!-- Arama Bitiş -->
        @if($yhastalar->count()>0)
        <div class="col-md-4">

            <h4><i class="fa fa-male" aria-hidden="true"></i> Yenidoğan</h4>
            <ul class="list-group">
                @foreach($yhastalar as $hasta)
        ...
        @endif
        @if($phastalar->count()>0)
        <div class="col-md-4">

            <h4><i class="fa fa-male" aria-hidden="true"></i> Pediatrik</h4>
            <ul class="list-group">
                @foreach($phastalar as $hasta)
                    <li class="list-group-item">
                                    <span class="pull-right">
                                        <a href="{{url('Akis/'.$hasta->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-clock-o" aria-hidden="true" data-toggle="tooltip" title="Akış Ekle"></i> </a>
                                        <a href="{{route('Hastalar.edit',$hasta->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil" data-toggle="tooltip" title="Düzenle"></i> </a>
        ...
        @endif
        @if($ehastalar->count()>0)
        <div class="col-md-4">

            <h4><i class="fa fa-male" aria-hidden="true"></i> Erişkin</h4>
            <ul class="list-group">
                @foreach($ehastalar as $hasta)
                    <li class="list-group-item">
                                    <span class="pull-right">
                                        <a href="{{url('Akis/'.$hasta->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-clock-o" aria-hidden="true" data-toggle="tooltip" title="Akış Ekle"></i> </a>
                                        <a href="{{route('Hastalar.edit',$hasta->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil" data-toggle="tooltip" title="Düzenle"></i> </a>
