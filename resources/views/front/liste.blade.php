            ...
            <header class="header-transparent">
                ...
                <div class="header-main">
                    <div class="container">
                        ...
                        <div class="header-logo"><a href="/" class="logo logo-static"><img src="assets\images\logo-white.png" alt="fooday" class="logo-img"></a><a href="/" class="logo logo-fixed"><img src="assets\images\logo.png" alt="fooday" class="logo-img"></a></div>
                        @include('front.nav')
                    </div>
                </div>
            </header>
