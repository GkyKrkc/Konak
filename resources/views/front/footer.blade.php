                        ...
                        <div class="ft-area1">
                            <div class="swin-wget swin-wget-about">
                                ...
                                <div class="wget-about-content">
                                    <p>Konak Restorant & Cafe 2008 yılından itibaren siz değerli müşterilerimize hizmet vermektedir. Konak Restorant & Cafe güler yüzlü personelleri ve kaliteli yemekleri ile siz değerli
                                        müşterilerimizin hizmetindedir.</p>
                                </div>
                                <div class="about-contact-info clearfix">
                                    <div class="address-info">
                                        <div class="info-icon"><i class="fa fa-map-marker"></i></div>
                                        <div class="info-content">
                                            <p>Şehit Abdullah Çavuş Mahallesi Alparslan Türkeş Bulvarı </p>
                                            <p>Onikişubat/Kahramanmaraş</p>
                                        </div>
                                    </div>
                    ...
                    <div class="ft-fixed-area">
                        <div class="reservation-box">
                            <div class="reservation-wrap">
                                <h3 class="res-title">Çalışma Saatlerimiz</h3>
                                ...
                                <h3 class="res-title">Rezervasyon !</h3>
